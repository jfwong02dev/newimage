...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('added_sale', 'You successfully added a new sale. Name: ' . $sales->uid . ', Amount: ' . $sales->amount);
    ...
    public function destroy(Sale $sale)
    {
        ...
        session()->flash('deleted_sale', 'You successfully deleted a sale, Name: ' . $sale->id . '.');
    ...
    public function restore($id)
    {
        ...
        session()->flash('restored_sale', 'You successfully restored a sale, Name: ' . $sale->id . '.');
