		...
		<div class="panel">
			...
			<div class="panel-body">
				<form action="{{route('payslips.show')}}" method="post" class="form-horizontal">
					...
					<div class="form-group{{ $errors->has('make_epf') ? ' has-error' : '' }}">
						<label for="month" class="col-sm-3 control-label"></label>
						<div class="col-sm-9">
							<div class="checkbox" style="margin: 0;">
								<label>
									<input type="checkbox" name="make_epf" checked> {{__('translate.field/make_epf')}}
								</label>
							</div> <!-- / .checkbox -->
						</div>
					</div>

					<div class="form-group{{ $errors->has('make_socso') ? ' has-error' : '' }}">
						<label for="month" class="col-sm-3 control-label"></label>
						<div class="col-sm-9">
							<div class="checkbox" style="margin: 0;">
								<label>
									<input type="checkbox" name="make_socso" checked> {{__('translate.field/make_socso')}}
								</label>
							</div> <!-- / .checkbox -->
						</div>
					</div>
